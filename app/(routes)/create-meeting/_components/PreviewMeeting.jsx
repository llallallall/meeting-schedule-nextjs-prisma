...
function PreviewMeeting({ formValue }) {
        ...
        const createTimeSlot=(interval)=>{
                ...
                const slots = Array.from({ length: totalSlots}, (_,i) => {
                        ...
                        const formattedHours = hours > 12 ? hours - 12 : hours; // Convert to 12 hours
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 mt-5' >
                                ...
                                <div className='p-4 border-r'>
                                        ...
                                        <div className='mt-5 flex flex-col gap-4'>
                                                ...
                                                <h2 className='flex gap-2'>{formValue?.locationUrl}</h2>
                                        </div>
                                </div>
                                {/** Time & Date Selection */}
                                <div className='md:col-span-2 flex p-4'>
                                        <div className='flex flex-col'>
                                                <h2 className='font-bold text-lg'>Select Time & Date </h2>
                                                <Calendar
                                                        mode="single"
                                                        selected={date}
                                                        onSelect={setDate}
